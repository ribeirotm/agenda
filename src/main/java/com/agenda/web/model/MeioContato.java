...
@NamedQueries({
    ...
    , @NamedQuery(name = "MeioContato.findByIdMeioContato", query = "SELECT m FROM MeioContato m WHERE m.idMeioContato = :idMeioContato")
    , @NamedQuery(name = "MeioContato.findByTipoContato", query = "SELECT m FROM MeioContato m WHERE m.tipoContato = :tipoContato")
    , @NamedQuery(name = "MeioContato.findByConteudo", query = "SELECT m FROM MeioContato m WHERE m.conteudo = :conteudo")})
public class MeioContato implements Serializable {
    ...
    public String toString() {
        return "agenda.MeioContato[ idMeioContato=" + idMeioContato + " ]";
    }
