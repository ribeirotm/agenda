...
@NamedQueries({
    ...
    , @NamedQuery(name = "Endereco.findByEndereco", query = "SELECT e FROM Endereco e WHERE e.enderecoReal = :enderecoReal")
...
public class Endereco implements Serializable {
    ...
    public Endereco(Integer idEndereco, String enderecoReal, String bairro, String cidade, String uf) {
        this.idEndereco = idEndereco;
    ...
    public String toString() {
        return "agenda.Endereco[ idEndereco=" + idEndereco + " ]";
    }
